...
"resource": {
  ...
  "macros":[{
      ...
      "function":"__jsm",
      "vtp_javascript":["template","(function(){try{var a=",["escape",["macro",2],8,16],",c=1E3*Number(a.split(\".\").pop()),b=33696E6,d=(new Date).getTime(),e=(new Date(c)).getTime();a=e+b;var f=Math.round((a-d)\/1E3);return f}catch(g){return b\/1E3}})();"]
    },{
      "function":"__jsm",
      ...
      "vtp_fieldsToSet":["list",["map","fieldName","cookieName","value",["macro",1]],["map","fieldName","cookieExpires","value",["macro",3]],["map","fieldName","page","value",["macro",4]]],
  ...
  "tags":[{
      ...
      "function":"__zone",
      "once_per_event":true,
      "vtp_childContainers":["list",["map","publicId","GTM-59VZ4FG","nickname","Standard"]],
      "vtp_boundaries":["list"],
      ...
      "metadata":["map"],
      "once_per_event":true,
      "vtp_html":"\u003Cscript async data-gtmsrc=\"https:\/\/boot.pbstck.com\/v1\/tag\/6d9fdfa6-b822-4b85-849c-36a47bc6c6ec\" type=\"text\/gtmscript\"\u003E\u003C\/script\u003E",
      ...
      "metadata":["map"],
      "once_per_event":true,
      "vtp_html":"\u003Cscript type=\"text\/gtmscript\" data-gtmsrc=\"https:\/\/adtrack.adleadevent.com\/mailNotification.php?st=77a41a76-2b26-4da2-8448-5e3c589c8ea8\" async=\"true\"\u003E\u003C\/script\u003E",
      "vtp_supportDocumentWrite":false,
      "vtp_enableIframeMode":false,
      "vtp_enableEditJsMacroBehavior":false,
      "tag_id":34
...
return null},Fd=!1;if(H.querySelectorAll)try{var Gd=H.querySelectorAll(":root");Gd&&1==Gd.length&&Gd[0]==H.documentElement&&(Fd=!0)}catch(a){}var Cd=Fd;var Ud={},L=null,Vd=Math.random();Ud.B="GTM-M7PZ8QT";Ud.Yb="9u1";Ud.Xh="";var Wd={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0},Xd={__paused:!0,__tg:!0},Yd;for(Yd in Wd)Wd.hasOwnProperty(Yd)&&(Xd[Yd]=!0);var Zd="www.googletagmanager.com/gtm.js";
var $d=Zd,ae=Ha(""),be=null,ce=null,de="//www.googletagmanager.com/a?id="+Ud.B+"&cv=2",ee={},fe={},ge=function(){var a=L.sequence||1;L.sequence=a+1;return a};
...
var Fe={},Ge=new Da,He={},Ie={},Le={name:"gmtdataLayer",set:function(a,b){m(Sa(a,b),He);Je()},get:function(a){return Ke(a,2)},reset:function(){Ge=new Da;He={};Je()}},Ke=function(a,b){if(2!=b){var c=Ge.get(a);Ae&&c!==Me(a.split("."))&&D(5);return c}return Me(a.split("."))},Me=function(a){for(var b=He,c=0;c<a.length;c++){if(null===b)return!1;if(void 0===b)break;b=b[a[c]]}return b},Ne=function(a,b){Ie.hasOwnProperty(a)||(Ge.set(a,b),m(Sa(a,b),He),Je())},Je=function(a){Fa(Ie,function(b,c){Ge.set(b,c);
...
return!a}function ul(){var a=tl();try{Uk(F["gmtdataLayer"],Ud.B)}catch(b){}return a}
var wl=function(){var a=Tc("gmtdataLayer",[]),b=Tc("google_tag_manager",{});b=b["gmtdataLayer"]=b["gmtdataLayer"]||{};wh(function(){b.gtmDom||(b.gtmDom=!0,a.push({event:"gtm.dom"}))});Jk(function(){b.gtmLoad||(b.gtmLoad=!0,a.push({event:"gtm.load"}))});b.subscribers=(b.subscribers||0)+1;var c=a.push;a.push=function(){var e;if(0<L.SANDBOXED_JS_SEMAPHORE){e=[];for(var f=0;f<arguments.length;f++)e[f]=new nl(arguments[f])}else e=[].slice.call(arguments,0);var h=c.apply(a,e);ol.push.apply(ol,e);if(300<
...
(void 0===F[a]||c&&!F[a])&&(F[a]=b);return F[a]},gm=function(a,b,c){return ef(a,b,void 0===c?!0:!!c)},hm=function(a,b,c){return 0===of(a,b,c)},im=function(a,b){if(Og()){b&&J(b)}else Xc(a,b)},jm=function(a){return!!El(a,"init",!1)},km=function(a){Cl(a,"init",!0)},lm=function(a,b){var c=(void 0===b?0:b)?"www.googletagmanager.com/gtag/js":$d;c+="?id="+encodeURIComponent(a)+"&l=gmtdataLayer";O(Qg("https://","http://",c))},mm=function(a,
...
Z.a.zone=[],function(){function a(p){for(var r=p.vtp_boundaries||[],t=0;t<r.length;t++)if(!r[t])return!1;return!0}function b(p){var r=Ud.B,t=r+":"+p.vtp_gtmTagId,q=dm("gtm.uniqueEventId")||0,v=oh(function(){return new h}),u=a(p),w=p.vtp_enableTypeRestrictions?p.vtp_whitelistedTypes.map(function(E){return E.typeId}):null;w=w&&Qa(w,f);if(v.registerZone(t,q,u,w))for(var y=p.vtp_childContainers.map(function(E){return E.publicId}),x=0;x<y.length;x++){var B=String(y[x]);if(v.registerChild(B,r,t)){var z=
0!==B.indexOf("GTM-");if(z){var A=function(E,G){em(arguments)};A("js",new Date);n?(A("config",B),l||lm(B,z)):(L.addTargetToGroup(B),yk({},B))}else lm(B,z)}}}var c={active:!1,isAllowed:function(){return!1},ih:function(){return!1}},d={active:!0,isAllowed:function(){return!0},ih:function(){return!0}},e={zone:!0,cn:!0,css:!0,ew:!0,eq:!0,ge:!0,gt:!0,lc:!0,le:!0,lt:!0,re:!0,sw:!0,um:!0},f={cl:["ecl"],ecl:["cl"],ehl:["hl"],hl:["ehl"]},h=function(){this.h={};this.i={}};h.prototype.checkState=function(p,r){var t=
this.h[p];if(!t)return d;var q=this.checkState(t.Re,r);if(!q.active)return c;for(var v=[],u=0;u<t.Fd.length;u++){var w=this.i[t.Fd[u]];w.xb(r)&&v.push(w)}return v.length?{active:!0,isAllowed:function(y,x){x=x||[];var B=q.isAllowed;if(!B(y,x))return!1;for(var z=0;z<v.length;++z)if(v[z].isAllowed(y,x))return!0;return!1}}:c};h.prototype.unregisterChild=function(p){delete this.h[p]};h.prototype.registerZone=function(p,r,t,q){var v=this.i[p];if(v)return v.m(r,t),!1;if(!t)return!1;this.i[p]=new k(r,q);
return!0};h.prototype.registerChild=function(p,r,t){var q=this.h[p];if(!q&&L[p]||q&&q.Re!==r)return!1;if(q)return q.Fd.push(t),!1;this.h[p]={Re:r,Fd:[t]};return!0};var k=function(p,r){this.h=[{eventId:p,xb:!0}];this.i=null;if(r){this.i={};for(var t=0;t<r.length;t++)this.i[r[t]]=!0}};k.prototype.m=function(p,r){var t=this.h[this.h.length-1];p<=t.eventId||t.xb!=r&&this.h.push({eventId:p,xb:r})};k.prototype.xb=function(p){if(!this.h||0==this.h.length)return!1;for(var r=this.h.length-1;0<=r;r--)if(this.h[r].eventId<=
p)return this.h[r].xb;return!1};k.prototype.isAllowed=function(p,r){r=r||[];if(!this.i||e[p]||this.i[p])return!0;for(var t=0;t<r.length;++t)if(this.i[r[t]])return!0;return!1};var l=!1;var n=!0;n=!1;(function(p){Z.__zone=p;Z.__zone.b="zone";Z.__zone.g=
!0;Z.__zone.priorityOverride=0})(function(p){b(p);J(p.vtp_gtmOnSuccess)})}();
